...
//Pulsar el boton de Alta.
	...
	static public void fillTeacherForm(WebDriver driver, String dnip, String namep, String lastnamep, String category) {
		WebElement dni = driver.findElement(By.name("dni"));
		dni.click();
		dni.clear();
		dni.sendKeys(dnip);
		...
		lastname.clear();
		lastname.sendKeys(lastnamep);
		WebElement passwordConfirm = driver.findElement(By.name("categoria"));
		passwordConfirm.click();
		passwordConfirm.clear();
		passwordConfirm.sendKeys(category);
//Pulsar el boton de Alta.
		By boton = By.className("btn");
		driver.findElement(boton).click();
	}
